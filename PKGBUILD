...
prepare() {
  ...
  patch -Np1 -i "${srcdir}/0110-raid6-add-Kconfig-option-to-skip-raid6-benchmarking.patch"
  ...
  patch -Np1 -i "${srcdir}/0113-give-rdrand-some-credit.patch"
  ...
  patch -Np1 -i "${srcdir}/0121-Enable-stateless-firmware-loading.patch"
