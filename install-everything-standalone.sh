...
git clone --recursive https://gitlab.manjaro.org/packages/extra/linux419-extramodules/spl_zfs.git
...
sed -i "s/_linuxprefix=.*/_linuxprefix=linux419-STUN/g" ./PKGBUILD
...
sed -i "s/package_linux419-spl/package_linux419-STUN-spl/g" ./PKGBUILD
sed -i "s/package_linux419-zfs/package_linux419-STUN-zfs/g" ./PKGBUILD
